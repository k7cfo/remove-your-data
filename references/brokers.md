...
Starting queue for public people-search and related opt-outs. URLs rot. Before filing, open the live privacy / opt-out page and confirm. If a URL is dead, file anyway via the site's current privacy page, then send a PR that fixes this file.

Do not pay a site to remove a listing.
...
| Broker | Opt-out | Notes |
| --- | --- | --- |
| Acxiom | https://www.acxiom.com/optout/ | Marketing wholesaler. |
...
| Registry | URL | Who |
| --- | --- | --- |
| California DROP + broker registry | https://privacy.ca.gov/drop/ and https://cppa.ca.gov/data_broker_registry/ | CA residents first |
