...
- `master` is protected: PR required; QA checks `browser-smoke` and `test (3.10)`–`test (3.13)` must be green. Admin bypass is emergency-only ([#9](https://github.com/k7cfo/remove-your-data/issues/9)).
